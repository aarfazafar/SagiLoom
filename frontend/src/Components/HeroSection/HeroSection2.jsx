...
function HeroSection() {
  ...
  useEffect(() => {
    const fetchSlides = async () => {
      try {
        setLoading(true)
        const querySnapshot = await getDocs(collection(fireDB, "heroImages"));
  ...
  return (
    <>
      {loading ? <Loading /> :
        <div className="relative h-screen w-full overflow-hidden" onMouseMove={handleMouseMove}>
          <AnimatePresence mode="wait">
            ...
            >
              <motion.div animate={{ x: mousePosition.x, y: mousePosition.y }} className="h-full w-full">
                <div
