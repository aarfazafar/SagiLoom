...
const Login = () => {
    ...
    const userLoginFunction = async () => {
        // validation 
        if ((userLogin.email === "" && userLogin.phone === "") || userLogin.password === "") {
    ...
    return (
        <div className='flex justify-center items-center h-screen'>
            ...
            <div className="login_Form bg-white px-8 py-6 border border-gray-300 rounded-xl shadow-md">
                ...
                <div>
                    <h2 className='text-black'>Don't Have an account <Link className='text-black font-bold' to={'/signup'}>Signup</Link></h2>
                </div>
